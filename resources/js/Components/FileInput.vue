<template>
    <span>
        <input class="input-file" type="file" name="mi-archivo" :v-model="modelValue" @input="$emit('update:modelValue', $event.target.value)" ref="input">
    </span>
    <div class="label-file flex space-x-3 bg-accent hover:bg-accent-dark rounded-md">
        ...
        <label class="" for="mi-archivo" v-text="fileLabel" style="cursor: pointer;"/>
    </div>
</template>
