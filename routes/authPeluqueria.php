...
use App\Http\Controllers\Auth\Peluqueria\AuthenticatedSessionPeluqueriaController;
use App\Http\Controllers\Auth\ConfirmablePasswordController;
use App\Http\Controllers\Auth\EmailVerificationNotificationController;
use App\Http\Controllers\Auth\EmailVerificationPromptController;
use App\Http\Controllers\Auth\NewPasswordController;
use App\Http\Controllers\Auth\PasswordResetLinkController;
use App\Http\Controllers\Auth\Peluqueria\RegisteredUserPeluqueriaController;
use App\Http\Controllers\Auth\VerifyEmailController;
use Illuminate\Support\Facades\Route;

Route::get('/peluqueria/register', [RegisteredUserPeluqueriaController::class, 'create'])
                ->middleware('guest')
...
Route::post('/peluqueria/login', [AuthenticatedSessionPeluqueriaController::class, 'store'])
                ->middleware('guest')->name('peluqueria.login');
